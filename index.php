            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <a href="/plants"
                    ...
                    <img class="rounded-full object-cover h-48 w-48 p-4"
                        src="assets/plants/<?php echo $plant["name"]; ?>.jpg"
                        alt="">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?php echo $plant["name"]; ?>
                        </h5>
                        <div class="grid grid-row-2">
                            <div class="row-start-1 flex items-center">
                                ...
                                $status = getPlantStatus($plant["current_temperature"], $plant["min_temperature"], $plant["max_temperature"]);
                            ...
                            <div class="row-start-2 flex items-center">
                                ...
                                <?php
                                $status = getPlantStatus($plant["current_water"], $plant["min_water"], $plant["max_water"]);
                                include "includes/views/status.php"
                                ?>
                            </div>
                        </div>
